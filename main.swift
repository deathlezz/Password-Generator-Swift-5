...
while attempts != 4 {
    ...
    if input == "" {
        ...
        if attempts == 2 {
            print()
            print("* Wrong key, \(3 - attempts) try left *")          // avoiding wrong keys
            
            attempts += 1
            
        } else if attempts == 3 {
            print()
            print("* See you next time *")          // avoiding wrong keys
            print()
            ...
            print()
            print("* Wrong key, \(3 - attempts) tries left *")          // avoiding wrong keys
